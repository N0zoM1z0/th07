...
extern u8 g_TargetRng49FE20[];

extern f32 __cdecl TargetVectorLength(const Vector3 *value);
extern f32 __cdecl TargetAngleToPlayer(const Vector3 *position);
extern u32 __cdecl TargetRandomU32(void *state);
extern f32 __cdecl TargetRandomF32(void *state);
...
i32 __fastcall ResolveInt(EnemyOverlay *enemy, i32 operand)
{
    ...
    case 0x2728: return (i32)TargetAngleToPlayer((Vector3 *)(enemy->bytes + 0x2B0C));
    case 0x2729: return *IntField(enemy, 0x2BCC);
    case 0x272A:
        delta.z = g_TargetFloat4BE410 - *FloatField(enemy, 0x2B14);
        delta.y = g_TargetFloat4BE40C - *FloatField(enemy, 0x2B10);
        delta.x = g_TargetFloat4BE408 - *FloatField(enemy, 0x2B0C);
        return (i32)TargetVectorLength(&delta);
    ...
    case 0x2747: return TargetRandomU32(g_TargetRng49FE20);
    case 0x2748:
        range = *IntField(enemy, 0x744);
        return *IntField(enemy, 0x748) + (range ? TargetRandomU32(g_TargetRng49FE20) % range : 0);
...
f32 EnemyOverlay::ResolveFloat(f32 operand)
{
    ...
    switch ((i32)operand)
    {
    case 0x2710: return (f32)*IntField(this, 0x6FC);
    case 0x2711: return (f32)*IntField(this, 0x700);
    case 0x2712: return (f32)*IntField(this, 0x704);
    case 0x2713: return (f32)*IntField(this, 0x708);
    ...
    case 0x271C: return (f32)*IntField(this, 0x72C);
    case 0x271D: return (f32)*IntField(this, 0x730);
    case 0x271E: return (f32)*IntField(this, 0x734);
    case 0x271F: return (f32)*IntField(this, 0x738);
    ...
    case 0x2728: return TargetAngleToPlayer((Vector3 *)(bytes + 0x2B0C));
    case 0x2729: return (f32)*IntField(this, 0x2BCC);
    case 0x272A:
        delta.z = g_TargetFloat4BE410 - *FloatField(this, 0x2B14);
        delta.y = g_TargetFloat4BE40C - *FloatField(this, 0x2B10);
        delta.x = g_TargetFloat4BE408 - *FloatField(this, 0x2B0C);
        return TargetVectorLength(&delta);
    case 0x272B: return (f32)*IntField(this, 0x2BB8);
    case 0x272C: return (f32)g_TargetByte62F647;
    case 0x272D: return (f32)*IntField(this, 0x744);
    case 0x272E: return (f32)*IntField(this, 0x748);
    case 0x272F: return (f32)*IntField(this, 0x74C);
    case 0x2730: return (f32)*IntField(this, 0x750);
    ...
    case 0x2747: return TargetRandomF32(g_TargetRng49FE20);
    case 0x2748: return TargetRandomF32(g_TargetRng49FE20) * *FloatField(this, 0x754) + *FloatField(this, 0x758);
    ...
    case 0x274C: return TargetRandomF32(g_TargetRng49FE20) * 6.2831855f - 3.1415927f;
    case 0x274D: return (f32)*IntField(this, 0x2E4C);
    ...
    case 0x2752: return (f32)*IntField(this, 0x2EBC);
    case 0x2753: return (f32)*IntField(this, 0x2EC0);
    case 0x2754: return (f32)*IntField(this, 0x2EC4);
    case 0x2755: return (f32)*IntField(this, 0x2EC8);
    case 0x2756: return (f32)*IntField(this, 0x2E10);
    case 0x2757: return (f32)*IntField(this, 0x2BC0);
